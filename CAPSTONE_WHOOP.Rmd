...
# F Test summary of sleepPerform_model4
wrapFTest(sleepPerform_model4)
...
recovery_model1 = lm(recovery ~ hrv + sleepPerform, data = whoop_df_explore)
summary(recovery_model1)

recovery_model2 = lm(recovery ~ hrv + timeInBed + totalSleep, data = whoop_df_explore)
summary(recovery_model2)

# F Test summary of recovery_model1
wrapFTest(recovery_model1)
